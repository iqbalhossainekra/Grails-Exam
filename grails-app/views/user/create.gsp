...
<head>
    ...
    <script>
        ...
        function getEmailVerfication(obj, emailName) {

//            alert(obj)
            var employeeCode = obj;
            $.ajax({
                type: "POST",
                url: "${request.contextPath}/User/getEmailName",
                dataType: 'JSON',
                data: "employeeCode=" + employeeCode,
                success: function (d) {
                    $('#' + emailName).text(d.message)
                },

                error: function (err) {
                    $('#' + emailName).text(err.message)
                    ...
                    <div class="card-body">
                        <g:form action="add" controller="User" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="email" id="username" class="form-control"  name="username"
                                           required onkeyup="getEmailVerfication(this.value,'emailName')">
                                    <span class="help-inline"
                                          id="emailName" style="color: red"></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <g:datePicker name="birthDate" value=""/>
                                    %{--<input type="text" class="form-control" name="birthDate" id="datepicker37"--}%
                                           %{--value="${formatDate(format: 'yyyy-MM-dd', date: new Date())}"--}%
                                           %{--required/>--}%
                                </div>
                            </div>
